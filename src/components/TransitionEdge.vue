...
import { getBezierPath, useVueFlow, Handle, Position} from '@vue-flow/core'
...
<template>
    ...
    <Transition name="fade">
        <circle v-if="showDot" ref="dot" r="5" cy="0" cx="0" :transform="`translate(${transform.x}, ${transform.y})`"
            style="fill: #fdd023" />
    </Transition>
</template>
